image:https://github.com/interscript/interscript-js/actions/workflows/js.yml/badge.svg["CI status", link="https://github.com/interscript/interscript-js/actions/workflows/js.yml"]
